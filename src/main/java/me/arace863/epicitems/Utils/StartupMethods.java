...
public class StartupMethods {
    ...
    public void registerCommands() {
        ...
        plugin.getCommand("warrioraxe").setExecutor(new Commands(plugin));
        plugin.getCommand("fireballrod").setExecutor(new Commands(plugin));
        plugin.getCommand("beearmourset").setExecutor(new Commands(plugin));
    ...
    public void registerEvents() {
        ...
        plugin.getServer().getPluginManager().registerEvents(new AirstrikeEvent(plugin), plugin);
        ...
        plugin.getServer().getPluginManager().registerEvents(new WarriorAxeEvent(plugin), plugin);
        plugin.getServer().getPluginManager().registerEvents(new FireballRodEvent(plugin), plugin);
        plugin.getServer().getPluginManager().registerEvents(new FullBeeArmourEvent(), plugin);
    }
