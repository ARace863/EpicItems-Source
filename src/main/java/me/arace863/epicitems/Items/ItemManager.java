...
public class ItemManager {
    ...
    private static void createWarriorsAxe() {
        ...
        lore.add("§7Damage: §c+70");
        lore.add("");
        lore.add("§6Item Ability: Mighty Launch §eRIGHT CLICK");
        ...
        meta.setLore(lore);
        AttributeModifier damage = new AttributeModifier(UUID.randomUUID(), "generic.armor", 20.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HAND);
        meta.addAttributeModifier(Attribute.GENERIC_ATTACK_DAMAGE, damage);
        item.setItemMeta(meta);
        WarriorAxe = item;
    }
    ...
    private static void createFireballRod() {
        ...
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(ChatColor.DARK_PURPLE + "Fireball Rod");
        List<String> lore = new ArrayList();
        lore.add("§7Damage: §c+15");
        lore.add("");
        lore.add("§6Item Ability: Rage §e§lRIGHT CLICK");
        lore.add("§7Release a horde of fireballs at");
        lore.add("§7your opponent.");
        lore.add(" ");
        lore.add(ChatColor.DARK_PURPLE + "§lEPIC");
        lore.add(" ");
