...
public class GUIMethods implements Listener {
    ...
    public void openVaultStoreGUI(Player player){
        ...
        ItemStack warriorsaxe = new ItemStack(Material.NETHERITE_AXE);
        ItemStack air = new ItemStack(Material.AIR);
        ...
        ItemMeta ultradrillmeta = ultradrill.getItemMeta();
        ...
        ItemMeta warriorsaxemeta = runaansbow.getItemMeta();
        warriorsaxemeta.setDisplayName(ChatColor.GOLD + "Warriors Axe");
        List<String> lore12 = new ArrayList();
        lore12.add(" ");
        lore12.add("§7Damage: §c+70");
        lore12.add("");
        lore12.add("§6Item Ability: Mighty Launch §eRIGHT CLICK");
        lore12.add("§7Launch your axe to do");
        lore12.add("§c100 §7damage on impact!");
        lore12.add("");
        lore12.add(ChatColor.GOLD + "" + ChatColor.BOLD + "LEGENDARY");
        lore12.add("");
        lore12.add(" ");
        lore12.add(ChatColor.GREEN + "$2,000");
        warriorsaxemeta.addItemFlags(ItemFlag.HIDE_ATTRIBUTES);
        warriorsaxemeta.setLore(lore12);
        warriorsaxe.setItemMeta(warriorsaxemeta);
        ...
        ItemStack[] menu_items = new ItemStack[]{acesword, airstrike, bonemerang, endermanbow, endermansword, evokerstaff, explosivebow, grapplinghook, healingsword, knockbackstick, rpg, runaansbow, ultradrill, warriorsaxe,  air,  air,  air,  air,  air,  air,  air,  air,  air,  air,  air,  air,  air,  air,  air,  air,  air, buyAll, air, air, air, air, air, air, air, air, air, air, air, air, backtomenu};
        gui.setContents(menu_items);
        player.openInventory(gui);
    }
    ...
    public void itemCreator(Player player){
        UtilOptions itemMethods = new UtilOptions(plugin);
        Inventory gui = Bukkit.createInventory(player, 36, ChatColor.RED + "Item Creator | EpicItems");
        ItemStack air = new ItemStack(Material.AIR);
        ItemStack name = new ItemStack(Material.IRON_SWORD);

        ItemStack forwardArrow = itemMethods.getSkull("https://textures.minecraft.net/texture/117f3666d3cedfae57778c78230d480c719fd5f65ffa2ad3255385e433b86e");

        ItemMeta lettermeta = forwardArrow.getItemMeta();
        lettermeta.setDisplayName(ChatColor.GREEN + "Next");
        forwardArrow.setItemMeta(lettermeta);

        ItemMeta namemeta = name.getItemMeta();
        lettermeta.setDisplayName(ChatColor.GREEN + "Item Material");
        name.setItemMeta(namemeta);

        ItemStack[] menu_items = new ItemStack[]{air, air, air, air, air, air, air, air, air, air, name, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, forwardArrow};
        gui.setContents(menu_items);
        player.openInventory(gui);
    }

    public void itemCreatorPhase2(Player player){
        UtilOptions itemMethods = new UtilOptions(plugin);
        Inventory gui = Bukkit.createInventory(player, 36, ChatColor.RED + "Item Creator | EpicItems");
        ItemStack air = new ItemStack(Material.AIR);

        ItemStack forwardArrow = itemMethods.getSkull("https://textures.minecraft.net/texture/117f3666d3cedfae57778c78230d480c719fd5f65ffa2ad3255385e433b86e");
        ItemStack backArrow = itemMethods.getSkull("https://textures.minecraft.net/texture/5ae78451bf26cf49fd5f54cd8f2b37cd25c92e5ca76298b3634cb541e9ad89");

        ItemMeta lettermeta = forwardArrow.getItemMeta();
        lettermeta.setDisplayName(ChatColor.GREEN + "Next");
        forwardArrow.setItemMeta(lettermeta);

        ItemMeta lettermeta1 = backArrow.getItemMeta();
        lettermeta1.setDisplayName(ChatColor.RED + "Go back");
        backArrow.setItemMeta(lettermeta1);

        ItemStack[] menu_items = new ItemStack[]{air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, air, backArrow, air, air, air, air, air, air, air, forwardArrow};
        gui.setContents(menu_items);
        player.openInventory(gui);
    }
}
