        ...
        if (!(sender instanceof Player)) {
            ...
            if (!player.hasPermission("epicitems.give")) {
                ...
                if (cmd.getName().equalsIgnoreCase("beearmourset")) {
                    player.getInventory().addItem(ItemManager.BeeHelmet);
                    player.getInventory().addItem(ItemManager.BeeChestplate);
                    player.getInventory().addItem(ItemManager.BeeLeggings);
                    player.getInventory().addItem(ItemManager.BeeBoots);
