                    ...
                    if (args[0].equalsIgnoreCase("setCooldown")) {
                        try {
                            ...
                            if (target == null){
                                ...
                                target.sendMessage(ChatColor.RED + "This is on cooldown for " + Math.round(((Double)Cooldown.cooldowns.get(target.getUniqueId()) - (double)System.currentTimeMillis()) / 1000.0D) + "s.");
