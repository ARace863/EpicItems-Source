...
public class RocketLauncherEvent implements Listener {
    ...
    public void onClick(PlayerInteractEvent event) {
        if (this.config.getBoolean("RocketLauncher", true)){
            if ((event.getAction().equals(Action.RIGHT_CLICK_BLOCK) || event.getAction().equals(Action.RIGHT_CLICK_AIR)) && event.getPlayer().getInventory().getItemInMainHand().getItemMeta() != null && event.getPlayer().getInventory().getItemInMainHand().getItemMeta().getLore() != null && event.getPlayer().getInventory().getItemInMainHand().getItemMeta().getLore().contains("§6Item Ability: Ricochet Rocket §e§lRIGHT CLICK")) {
                ...
                while(var3.hasNext()) {
                    ...
                    if (entity instanceof LivingEntity) {
                        ...
                        if (!livingEntity.equals(firework.getShooter()) && !livingEntity.equals(firework)) {
                            livingEntity.damage((double)(Integer.parseInt(firework.getCustomName()) / 2));
                        }
                    }
                }
            }
